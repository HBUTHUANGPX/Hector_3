...
private:
    ...
    double hight;  
    double p_rel_max_param,Kp_param,Kd_param,Kptoe_param,Kdtoe_param;
    // double Q[12];
    double Q_roll,Q_pitch,Q_yaw,Q_x,Q_y,Q_z,Q_droll,Q_dpitch,Q_dyaw,Q_dx,Q_dy,Q_dz;
    double swing_hight,first_hight;
};
