...
void Constraints::CalculateConstarintMatrix() {
        ...
        fpt lt;
        fpt lh;
        ros::param::get("Constraints/CalculateConstarintMatrix/mu",mu);
        ros::param::get("Constraints/CalculateConstarintMatrix/lt",lt);
        std::cout<<"Constraints/CalculateConstarintMatrix/lt:"<<lt<<std::endl;
        ros::param::get("Constraints/CalculateConstarintMatrix/lh",lh);
        std::cout<<"Constraints/CalculateConstarintMatrix/lh:"<<lh<<std::endl;
